  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-0.5">
              BYMA · CEDEARs · Índices · Commodities · Sentiment
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {/* Layout principal: columna izquierda (chart + tablas) + sidebar derecho */}
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-8">
            ...
            {/* Copilot — contexto mercados */}
            <section>
              <CopilotBox
                context="mercados"
                placeholder="¿Qué sectores lideran hoy? ¿Cómo está el Merval vs S&P?"
              />
            </section>
          ...
          <div className="w-72 shrink-0 space-y-4">
            ...
            {/* Fear & Greed */}
            {fearGreedData && (
              <FearGreedWidget data={fearGreedData} />
            )}

            {/* Commodities compacto si no hay en main */}
            {commoditiesData.length === 0 && (
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-center text-zinc-500 text-xs">
                Commodities no disponibles
              </div>
            )}
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-transparent border border-emerald-800/40 rounded-xl p-4 text-center">
              ...
              <a
                href="/grafico"
                className="inline-block w-full text-center text-xs font-semibold bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg py-2 transition-colors"
              >
                Abrir terminal →
              </a>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
              ...
              <div className="space-y-1.5 text-[10px] text-zinc-600">
                ...
                <div className="flex justify-between"><span>Índices</span><span className="text-zinc-500">FMP · 60s</span></div>
              </div>
            </div>
          </div>
        </div>
